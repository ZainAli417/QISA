...
class MeetingAppBar_web extends StatefulWidget {
  final String token;
  final Room meeting;
  final String recordingState;
  final bool isFullScreen;

  const MeetingAppBar_web({
    Key? key,
  ...
  @override
  State<MeetingAppBar_web> createState() => MeetingAppBar_webState();
}

class MeetingAppBar_webState extends State<MeetingAppBar_web>
    with MeetingAppBarLogic<MeetingAppBar_web> {
